    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-10">
          ...
          <div className="bg-[#131B2B] p-8 rounded-2xl border border-white/5 shadow-xl">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h2 className="text-2xl font-bold text-white mb-2">Application Activity</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-[#06090F] p-6 rounded-xl border border-white/5 border-l-4 border-l-[#8B7CFF]">
                <div className="text-4xl font-bold text-[#8B7CFF] mb-2">12</div>
                <div className="text-xs font-bold text-gray-500 tracking-widest uppercase">Applied</div>
              </div>
              <div className="bg-[#06090F] p-6 rounded-xl border border-white/5 border-l-4 border-l-white">
              ...
              <div className="bg-[#06090F] p-6 rounded-xl border border-white/5 border-l-4 border-l-pink-500">
                <div className="text-4xl font-bold text-pink-500 mb-2">02</div>
          ...
          <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 gap-4">
              <h2 className="text-2xl font-bold text-white">Top Match Opportunities</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Card 1 */}
              <div className="bg-[#131B2B] rounded-2xl border border-white/5 shadow-xl overflow-hidden group cursor-pointer hover:border-[#8B7CFF]/50 transition-colors flex flex-col h-auto sm:h-72">
                ...
                {/* Content Area */}
                <div className="p-6 flex-1 flex flex-col justify-end bg-[#131B2B]">
                  <h3 className="text-xl font-bold text-white mb-1">Senior UX Designer</h3>
                  <p className="text-sm text-gray-400 mb-5">Lumina Digital Arts • Remote</p>
              ...
              <div className="bg-[#131B2B] rounded-2xl border border-white/5 shadow-xl overflow-hidden group cursor-pointer hover:border-[#8B7CFF]/50 transition-colors flex flex-col h-auto sm:h-72">
                ...
                {/* Content Area */}
                <div className="p-6 flex-1 flex flex-col justify-end bg-[#131B2B]">
                  <h3 className="text-xl font-bold text-white mb-1">Product Architect</h3>
                  <p className="text-sm text-gray-400 mb-5">Vertex Solutions • Hybrid</p>
                  <div className="flex flex-wrap gap-2 mt-auto">
        ...
        <div className="space-y-8 xl:col-span-1">
          ...
          <div className="bg-[#131B2B] p-8 rounded-2xl border border-white/5 shadow-xl border-t-2 border-t-pink-500">
            ...
            <div className="bg-[#06090F] p-5 rounded-xl border border-white/5 mb-6 flex justify-between items-center">
              <div>
            ...
            <button className="w-full py-4 bg-[#1A2235] hover:bg-[#232D45] border border-white/5 rounded-xl text-xs font-bold tracking-widest text-white uppercase transition-colors">
              Explore Pathways
            </button>
          </div>

          {/* Boost Your Matches Promo Card */}
          <div className="relative p-8 rounded-2xl border border-white/5 shadow-xl overflow-hidden bg-gradient-to-br from-[#1A2342] to-[#131B2B]">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row xl:flex-col items-start sm:items-center xl:items-start justify-between gap-6">
              <div>
                <h3 className="text-2xl font-bold text-white mb-2 leading-tight">Boost Your<br/>Matches</h3>
              ...
              <button className="w-full sm:w-auto xl:w-full py-4 px-6 bg-[#8B7CFF] hover:bg-[#7a6ce0] text-white rounded-xl text-xs font-bold tracking-widest uppercase transition-colors shadow-lg shadow-[#8B7CFF]/20 whitespace-nowrap">
                Upgrade to Pro
              </button>
            </div>
          </div>
          ...
          <div className="bg-[#131B2B] p-8 rounded-2xl border border-white/5 shadow-xl">
            <h3 className="text-xs font-bold text-gray-400 tracking-widest uppercase mb-8">Career Trajectory</h3>
            <div className="relative pl-8 border-l border-white/10 ml-4 space-y-10">
